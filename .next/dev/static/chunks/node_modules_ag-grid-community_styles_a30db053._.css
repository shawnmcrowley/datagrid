/* [project]/node_modules/ag-grid-community/styles/ag-grid.css [app-client] (css) */
body {
...
.ag-rtl .ag-header-cell:not(.ag-right-aligned-header) .ag-header-label-icon, .ag-rtl .ag-header-cell:not(.ag-right-aligned-header) .ag-header-menu-icon, .ag-ltr .ag-header-cell.ag-right-aligned-header .ag-header-label-icon, .ag-ltr .ag-header-cell.ag-right-aligned-header .ag-header-menu-icon {
  margin-right: var(--ag-grid-size);
}
...
/* [project]/node_modules/ag-grid-community/styles/ag-theme-quartz.css [app-client] (css) */
@font-face {
...
.ag-theme-quartz-dark {
  --ag-background-color: #1f2936;
  --ag-foreground-color: #fff;
  --ag-border-color: #ffffff29;
  --ag-secondary-border-color: color-mix(in srgb, transparent, var(--ag-foreground-color) 10%);
  --ag-header-background-color: #28313e;
  --ag-tooltip-background-color: #212b38;
  --ag-control-panel-background-color: #28313e;
  --ag-input-disabled-background-color: #68686e12;
  --ag-card-shadow: 0 1px 20px 1px black;
  --ag-input-border-color: var(--ag-border-color);
  --ag-input-disabled-border-color: #ffffff12;
  ...
  --ag-popup-shadow: 0 0px 20px #0000004d;
...
.ag-theme-quartz-dark .ag-chart-menu {
  background-color: color-mix(in srgb, #1827324d, var(--ag-background-color) 30%);
}
...
/*# sourceMappingURL=node_modules_ag-grid-community_styles_a30db053._.css.map*/